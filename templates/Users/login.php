    ...
    <div class="row">
        <main class='col-12 col-lg-8 p-3'>
            ...
            <div class="form-group">
                <?= $this->Form->control('username', ['label' => __('Adresse électronique'), 'type' => 'email', 'required' => true, 'class' => 'form-control']) ?>
                <?= $this->Form->control('password', ['label' => __('Mot de passe'), 'required' => true, 'class' => 'form-control']) ?>
            </div>
            <div class="form-group">
                <div class="form-check">
                    <?= $this->Form->control('rememberme', ['label' => __('rester connecté'), 'type' => 'checkbox', 'class' => 'form-check-input']) ?>
                </div>
            </div>
