        ...
        <header class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav my-2 my-lg-0">
                ...
                <li class='nav-item dropdown'>
                    <?= $this->Html->link(
                        $this->Html->tag('i', '', ['class' => 'far fa-user-circle', 'title' => 'Mon Compte']) .
                            $this->Html->tag('span', 'Mon Compte', ['class' => 'sr-only']) .
                            $this->Html->tag('span', 'Mon Compte', ['class' => 'd-lg-none']),
                        '#',
                        [
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profilemenu">
                        <?= $this->Html->link(
                            $this->Html->tag('i', '', ['class' => 'fas fa-bell']) . 'Mes évaluations',
                            '/personals/ongoing',
                            ['class' => 'dropdown-item', 'title' => "Les vidéos que j'ai évalué"]
                        ) ?>
                        <?= $this->Html->link(
                            $this->Html->tag('i', '', ['class' => 'fas fa-info-circle']) . ' Profil',
                            '/personals/profile',
                            ['class' => 'dropdown-item', 'title' => 'Mes paramètres']
                        ) ?>
